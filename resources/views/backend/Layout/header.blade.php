...
<head>
    ...
    <link rel="icon" href="http://localhost:8080/s-cart/public/images/icon.png" type="image/png" sizes="16x16">
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{!! asset('dmin/LTE/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') !!}a">
    <!-- Theme style -->
